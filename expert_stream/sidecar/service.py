...
class ExpertSidecar:
    def __init__(
        ...
        *,
        ...
        # Public surface: no net-time actuation governor. Heads
        # receive governor=None (always allowed to actuate when on).
        # Wrap ships off by default so that is a no-op unless opted in.
    ...
    def _tick_log(self) -> None:
        ...
        parts = [
            ...
            f"topk={w.topk}",
            # Byte balance for speculative issue (wrap off by default).
